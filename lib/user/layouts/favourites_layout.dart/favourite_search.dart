...
class SearchFavouriteProducts extends StatelessWidget {
          ...
          body: Padding(
            ...
            child: Column(
              children: [
                ...
                searchText.text == '' || cubit.favProductsResult!.length == 0
                    ? Expanded(
                        child: ListView.separated(
                            itemBuilder: (context, index) {
                              return buildSearchProduct(
                                  context, cubit.allFavourites![index], index);
                            },
                    ...
                    : Expanded(
                        child: ListView.separated(
                            itemBuilder: (context, index) {
                              return buildSearchProduct(context,
                                  cubit.favProductsResult![index], index);
                            },
                            separatorBuilder: (context, index) => SizedBox(
                                  height: 20,
                                ),
                            itemCount: cubit.favProductsResult!.length))
              ],
            ),
          ),
        );
